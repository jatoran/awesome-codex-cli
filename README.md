...
- [jatoran/swe-mux](https://github.com/jatoran/swe-mux) - Run several Codex CLI sessions side by side in real terminals with live per-session status, and pick up the same live sessions on your phone over Tailscale. ![GitHub stars](https://img.shields.io/github/stars/jatoran/swe-mux?style=flat-square)
